...
var isThenable = require('@wareset-utilites/is/isThenable');
...
var awaiter = (t, o, s) => {
  isThenable.isThenable(t) ? t.then(t => {
    o(t, s);
  }) : o(t, s);
};
...
var isNotEqualValue = (e, i) => !e._.strict && (isObject.isObject(i) || isFunction.isFunction(i)) || !is.is(e._.k, i);
...
defineProperty.defineProperty(p, "$", {
  get: p.get,
  set: p.set
});

var _loop = function (b, _v) {
  defineProperty.defineProperty(p, b[_v], {
    value: function (...t) {
      var e = this.get();
