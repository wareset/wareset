...
var instanceofFactory = require('@wareset-utilites/is/lib/instanceofFactory');
...
var awaiter = (o, r, s) => {
  isPromise.isPromise(o) ? Promise.all([o, s, r]).then(t$1) : r(o, s);
};
...
var removeOrder = u => {
  u[1][2] = u[2], o === u ? o = u[1] : u[2] && (u[2][1] = u[1], l[0] > u[1][0] && (l = u[1]), r$1 < 4e4 ? r$1++ : t || (t = !0, timeout.timeout(99, n))), u[0] = -1, u[1] = u[2] = null;
};
...
var storeSubscribe = (_$1, a, l) => {
  var p = isArray.isArray(_$1) ? [..._$1] : [_$1],
      u = [],
      b = {};
...
var proxyDefault = (n, p) => {
  ...
  } else if (_(n) && (n = n._.j), !is.is(f.j, n) || !f.strict && (isFunction.isFunction(n) || isObject.isObject(n))) {
    var _o9 = f.j;
    p.value = f.j = n;
...
defineProperty.defineProperty(m, "$", {
  get: m.get,
  set: m.set
});

var _loop = function (p, d) {
  defineProperty.defineProperty(m, d[p], {
    value: function (...t) {
      var o = this.get();
...
var _ = instanceofFactory.instanceofFactory(Store);
...
var storeFactory = e => (e || (e = {
  ...
  b: !1,
  c: !1
}), (s, c, n, a) => (isArray.isArray(c) || (c = _(c) ? [c] : (a = n, n = c, null)), isFunction.isFunction(n) || (a = n, n = null), new Store(e, s, c, n, a)));
