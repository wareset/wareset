...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.eventer = {}));
    ...
    */
    var e = "undefined" != typeof window,
      ...
      for (h.lastIndex = 0; t = h.exec(e);) (r = t[1]) ? n.type = r : (r = t[2]) && (n.num = 1e3 * +r), (r = t[3]) || (r = t[4]) ? (n.kLen++, n.keys[r] = 1) : (r = t[5]) && (r in n || (r = r[0]) in n) && (n[r] = !0);
    ...
    var m = e ? (e, t) => {
      ...
      var t,
          r = new WeakMap(),
          a = e => "offsetWidth" in e ? [e.offsetWidth, e.offsetHeight] : [e.clientWidth, e.clientHeight],
          o = e => {
        var n = r.get(e),
            [s, o] = a(e);
      ...
      var o,
        ...
        return t;
          ...
          x = e => !e.xy || h === H && (e.x || e.l) || h === O && (e.x || e.r) || h === C && (e.y || e.u) || h === F && (e.y || e.d),
        ...
        if (r || 1 === e.touches.length) {
          ...
          for (Le = o; Le; Le = Le.parentNode) if (We = Y.get(Le)) for (var Ie = 0; Ie < We.length; Ie++) (Xe = We[Ie])[1] === n ? (We.splice(Ie--, 1), We.length || (Y.delete(Le), X.has(Le) || me(Le))) : (ze = (Ye = Xe[0]).type) in Ee || (Ye.stop && (Ee[ze] = !0), Re = Xe[1], Te = Xe[2], (t !== T || x(Ye)) && Re(D(ze, e)));

          for (Le = ue; Le; Le = Le.parentNode) if (We = X.get(Le)) for (var Me = 0; Me < We.length; Me++) if ((Xe = We[Me])[1] === n) We.splice(Me--, 1), We.length || (X.delete(Le), Y.has(Le) || me(Le));else if (!((ze = (Ye = Xe[0]).type) in Ee)) switch (Ye.stop && (Ee[ze] = !0), Re = Xe[1], Te = Xe[2], ze) {
            case E:
        ...
        if (r(t)) {
          ...
          switch (k) {
            ...
            case A:
              ...
              var b = u(d);
              y.once && d.push(o), y.kLen && (b = f(b, y)), y.self && (b = v(b)), y.trusted && (b = g(b)), Y.has(e) || X.has(e) || (e => {
